    ...
    <div className='ExchangeForm_content'>
      ...
      <div className="ExchangeForm__flex__content">
        <div className="ExchangeForm__flex__curr">
          ...
          {iconSource ? <img className="ExchangeForm__icon" src={iconSource} alt={sourceCurrency} /> : ""}
        </div>
        <div className="ExchangeForm__flex__curr">
          ...
          {iconTarget ? <img className="ExchangeForm__icon" src={iconTarget} alt={sourceCurrency} /> : ""}
        </div>
      </div>
      <div className="ExchangeForm__result">
        ...
        <div className='ExchangeForm__result__layout'>
          <label className="ExchangeForm__result__text">You will get: </label>
          <input className="ExchangeForm__result__result" type='text' value={`${result} `+ targetCurrency} readOnly />
        </div>
      )}    
       ...
       <div className="flex__center">
        <button  className="Exchangeform_button" type='submit'>Exchange!</button></div>
      </form>
     
      <div className="flex__center">
      {showResultText && result !== null && (
        <p className="ExchangeForm__result__amount">{`You Got :  ${result}  ` + targetCurrency + ``}</p>
      )}
      </div>
    </div>
  );
